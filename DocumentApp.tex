...
\title{\textbf{Tài liệu Dự án: VoiceShieldAI}}
...
\section{Tên Dự án}
\textbf{VoiceShieldAI} (Lá chắn giọng nói tích hợp trí tuệ nhân tạo).
...
Quy trình xử lý của VoiceShieldAI diễn ra theo các bước nghiêm ngặt sau:
