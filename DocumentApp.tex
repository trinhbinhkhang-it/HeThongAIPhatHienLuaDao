...
\title{\textbf{Tài liệu Dự án: DeepCheck}}
...
\section{Tên Dự án}
\textbf{DeepCheck} (Hệ thống phát hiện lừa đảo tích hợp trí tuệ nhân tạo).
...
Quy trình xử lý của DeepCheck diễn ra theo các bước nghiêm ngặt sau:
