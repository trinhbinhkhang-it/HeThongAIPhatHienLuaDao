...
\title{\textbf{Tài liệu Dự án: SafeCallsCT}}
...
\section{Tên Dự án}
\textbf{SafeCallsCT} (Hệ thống phát hiện lừa đảo tích hợp trí tuệ nhân tạo).
...
Quy trình xử lý của SafeCallsCT diễn ra theo các bước nghiêm ngặt sau:
